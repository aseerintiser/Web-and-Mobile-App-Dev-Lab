...
export default function TimerList(){
    ...
    return(
        ...
        {!addButton && <div>
            ...
            <button onClick = {changeAddButtonStatus}><p> <b> + </b></p></button>
        </div>}
        {addButton && <div>
            <form>
                <label><b> Title: </b></label>
                <textarea name = {"title"} value = {formData.title} onChange = {onChangeFormData}></textarea> <br></br>
                <label><b> Project: </b></label>
                <textarea name = {"project"} value = {formData.project} onChange = {onChangeFormData}></textarea> <br></br>
